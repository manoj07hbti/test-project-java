...
public class DemoString {
    ...
    /* todo Memory areas in Java
           ...
           3-Stack Memory (LIFO): method calls and variable declaration
           ...
           // StringBuffer  is synchronized so used in multithreaded environment
           // unary Operator : obj +=value -->  obj =obj+value
           //  rev+=ch[i];  -->> rev=rev+ch[i] ;
//TODO Write a program to reverse a String
//TODO Write a program to reverse a String with special character @#$*
...
*/
    public static void main(String args[]) {
        ...
        String str1 = new String("welcome"); // Object heap memory
        ...
        if (str1.equals(str2)) { // compares content in Object
